...
Public Class crAllPendingCases
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EobBTS.crAllPendingCases.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrAllPendingCases
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crAllPendingCases = New crAllPendingCases()
        rpt.Site = Me.Site
        Return rpt
    End Function
