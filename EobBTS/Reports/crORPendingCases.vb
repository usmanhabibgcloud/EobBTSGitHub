...
Public Class crORPendingCases
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EobBTS.crORPendingCases.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrORPendingCases
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crORPendingCases = New crORPendingCases()
        rpt.Site = Me.Site
        Return rpt
    End Function
