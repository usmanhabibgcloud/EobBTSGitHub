...
Public Class crDelayCondonation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EobBTS.crDelayCondonation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDelayCondonation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDelayCondonation = New crDelayCondonation()
        rpt.Site = Me.Site
        Return rpt
    End Function
