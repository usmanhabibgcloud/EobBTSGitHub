...
Public Class crRejectionLetter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EobBTS.crRejectionLetter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrRejectionLetter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crRejectionLetter = New crRejectionLetter()
        rpt.Site = Me.Site
        Return rpt
    End Function
