...
Public Class frmORverificationReminder
    Implements IAddBtn
    Implements IEditBtn
    Implements ISaveBtn
    ...
    Private Sub frmCaseSettle_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            txtBeforeDate.Text = Format(Today(), "dd/MM/yyyy")
    ...
    Public Sub FillORVerification()
        Try
            ...
            cls.GetRecord("execute spORVerReminderSent_Edit '" & intORVerificationID & "'", cn)
            ...
            For i As Integer = 0 To cls.ds.Tables(1).Rows.Count - 1
                ...
                Me.grdORVerification.Item("FirstIntDate", i).Value = cls.ds.Tables(1).Rows(i)("FirstIntimationDate")
    ...
    Public Sub ActionEdit() Implements IEditBtn.ActionEdit
        ...
        frmVoucherSearch.myTag = "OR_Verification_Reminder"
...
AddMode:
        Try
            ...
            cls.AddRecord(tblDetail, cn, "tblORVerificationReminderDetail", "tblORVerificationReminderMain", "ORVerificationID", fldNames, fldValues)
            cls = Nothing
            ZeroPoint()
            Exit Sub
        Catch ex As Exception
...
EditMode:
        Try
            ...
            cls.UpdateRecord(tblDetail, cn, "tblORVerificationReminderDetail", "tblORVerificationReminderMain", "ORVerificationID", fldNames, fldValues, intORVerificationID)
            cls = Nothing
            ZeroPoint()
        Catch ex As Exception
            MsgBox(ex.Message)
    ...
    Public Sub ActionDelete() Implements IDeleteBtn.ActionDelete
        ...
        If EditMode = True Then
            If MessageBox.Show("Are you sure you want to Delete the Record", "Delete Record", MessageBoxButtons.YesNo, MessageBoxIcon.Information) = Windows.Forms.DialogResult.Yes Then
                ...
                Dim cls As New ClsWriter
                cls.DeleteRecord("tblORVerificationReminderMain", "ORVerificationID", intORVerificationID, cn)
                cls = Nothing
                ZeroPoint()
    ...
    Private Sub txtBDate_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtORVerificationDate.Validating
        ...
        End Try
    End Sub
    Private Sub txtBeforeDate_Validating(sender As Object, e As CancelEventArgs) Handles txtBeforeDate.Validating
        Try
            Dim dt As New DateTime(Strings.Right(txtBeforeDate.Text, 4), Strings.Mid(txtBeforeDate.Text, 4, 2), Strings.Left(txtBeforeDate.Text, 2))
            'If Not (dt >= dtStartDate And dt <= dtEndDate) Then
    ...
    Private Sub txt_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtORVerificationDate.GotFocus
        ...
        SelectText(sender)
    End Sub
    Private Sub txtBeforeDate_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtBeforeDate.GotFocus
    ...
    Private Sub btnLoad_Click(sender As Object, e As EventArgs) Handles btnLoad.Click
        ...
        Try
            ...
            cls.GetRecord("execute spORVerReminder_Sent '" & fnTextToDate(txtBeforeDate.Text) & "'", cn)
            Me.grdORVerification.RowCount = 0
            Me.grdORVerification.Enabled = True
            ...
            For i As Integer = 0 To cls.ds.Tables(0).Rows.Count - 1
                ...
                Me.grdORVerification.Item("FirstIntDate", i).Value = cls.ds.Tables(0).Rows(i)("FirstIntimationDate")
            Next
            cls = Nothing
        Catch ex As Exception
            MsgBox(ex.Message)
